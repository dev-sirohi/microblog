...
public interface IUserLikeService
{
    ...
    Task<(long likesCount, bool isLikedByUser)> GetPostLikesAndIsLikedByUserAsync(long userId, long postId,
        bool useCache = true);

    Task<List<long>>
        GetRecentlyLikedPostIdsByUserAsync(long userId, int page = 1, int limit = 10, bool useCache = true);
